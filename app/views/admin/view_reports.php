...
<div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:2rem;flex-wrap:wrap;gap:1rem;">
    ...
    <a href="index.php?page=admin&action=index" class="btn btn-outline btn-sm">← Back to Dashboard</a>
</div>
...
<?php else: ?>
    ...
    <div style="display:flex;gap:.75rem;margin-top:2rem;flex-wrap:wrap;">
        <a href="index.php?page=admin&action=delete_post&id=<?= $post['id'] ?>"
           ...
           data-confirm="Permanently delete this post? This action cannot be undone.">🗑️ Delete Post</a>
        <a href="index.php?page=admin&action=index"
           class="btn btn-outline">← Back to Admin Panel</a>
    </div>
<?php endif; ?>
